...
var OrderStyles = external_styled_components_default.a.div.withConfig({
  ...
  componentId: "sc-1jpsdtc-0"
})(["font-family:'Slabo 27px',serif;max-width:1000px;margin:0 auto;border:1px solid ", ";box-shadow:", ";padding:2rem;border-top:5px solid ", ";;& > p{display:grid;grid-template-columns:1fr 5fr;margin:0;border-bottom:1px solid ", ";span{padding:1rem;&:first-child{font-weight:900;text-align:right;}}}.order-item{border-bottom:1px solid ", ";display:grid;grid-template-columns:300px 1fr;align-items:center;grid-gap:2rem;padding-bottom:2rem;img{width:100%;object-fit:cover;}}.buttonList{display:grid;width:100%;grid-template-columns:repeat(auto-fit,minmax(100px,1fr));grid-gap:1px;background:", ";& > *{background:white;border:0;font-size:1.5rem;padding:1rem;font-weight:700;text-align:center;}}"], function (props) {
  return props.theme.offWhite;
}, function (props) {
  return props.theme.bs;
}, function (props) {
...
function (_React$Component) {
  ...
  function Order() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "convertFee", function (val) {
      var finalMoney = 0;
  ...
  _createClass(Order, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        return external_react_default.a.createElement(styles_OrderStyles, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "Palazar | Order ", order.id, " ")), external_react_default.a.createElement("p", null, external_react_default.a.createElement("span", null, "Order Id:"), external_react_default.a.createElement("span", null, _this2.props.id)), external_react_default.a.createElement("p", null, external_react_default.a.createElement("span", null, "Charge"), external_react_default.a.createElement("span", null, order.user.name, " ", order.user.lastName)), external_react_default.a.createElement("p", null, external_react_default.a.createElement("span", null, "Created At"), external_react_default.a.createElement("span", null, Object(external_date_fns_["format"])(order.createdAt, 'MMMM d, YYYY h:mm a', {
          awareOfUnicodeTokens: true
        }))), external_react_default.a.createElement("p", null, external_react_default.a.createElement("span", null, "Order Total"), order.total == 0 && external_react_default.a.createElement("span", null, Object(formatMoney["a" /* default */])(order.total + 200)), order.total !== 0 && external_react_default.a.createElement("span", null, Object(formatMoney["a" /* default */])(order.total + 200))), external_react_default.a.createElement("p", null, external_react_default.a.createElement("span", null, "Request Count"), external_react_default.a.createElement("span", null, order.requests.length)), external_react_default.a.createElement("div", {
          className: "items"
          ...
          }, external_react_default.a.createElement("h2", null, request.name), external_react_default.a.createElement("p", null, "Qty: ", request.quantity), external_react_default.a.createElement("p", null, "SubTotal: $", _this2.convertFee(request.price * request.quantity)), external_react_default.a.createElement("p", null, request.details), request.price == 0 && external_react_default.a.createElement("p", null, "With a fee of $2"), request.price !== 0 && external_react_default.a.createElement("p", null, "With a fee of $2"))), external_react_default.a.createElement("div", {
            className: "buttonList"
          }, external_react_default.a.createElement(Chat["a" /* default */], {
            vendor: request.requestedId,
            client: request.user.id
