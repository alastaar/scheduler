...
// EXTERNAL MODULE: ./components/SingleUserBlock.js
var SingleUserBlock = __webpack_require__(45);

// CONCATENATED MODULE: ./components/ChatList.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var USER_CHATS_QUERY = external_graphql_tag_default()(_templateObject());
var OrderUl = external_styled_components_default.a.ul.withConfig({
  displayName: "ChatList__OrderUl",
  componentId: "shoy3l-0"
})(["display:grid;grid-gap:4rem;grid-template-columns:repeat(auto-fit,minmax(40%,1fr));"]);

var ChatList_ChatList =
/*#__PURE__*/
function (_React$Component) {
    ...
    value: function render() {
      return external_react_default.a.createElement(User["b" /* default */], null, function (_ref) {
        ...
        return external_react_default.a.createElement(external_react_apollo_["Query"], {
          ...
          return external_react_default.a.createElement("div", null, external_react_default.a.createElement(OrderUl, null, chats.map(function (chat) {
            return external_react_default.a.createElement(external_react_default.a.Fragment, null, me.id === chat.client && me.id !== chat.vendor && external_react_default.a.createElement(external_react_apollo_["Query"], {
              query: SingleUserBlock["a" /* SINGLE_USER_QUERY */],
              variables: {
                id: chat.vendor
              }
            }, function (_ref3) {
              ...
              return external_react_default.a.createElement(OrderItemStyles["a" /* default */], {
                ...
                className: "order-meta"
              }, external_react_default.a.createElement("p", null, user.name)))));
            }), me.id === chat.vendor && me.id !== chat.client && external_react_default.a.createElement(external_react_apollo_["Query"], {
              query: SingleUserBlock["a" /* SINGLE_USER_QUERY */],
              variables: {
                id: chat.client
              }
            ...
            }), me.id === chat.client && me.id === chat.vendor && external_react_default.a.createElement(external_react_apollo_["Query"], {
              query: SingleUserBlock["a" /* SINGLE_USER_QUERY */],
              variables: {
                id: chat.vendor
              }
...
/* harmony default export */ var components_ChatList = (ChatList_ChatList);
// EXTERNAL MODULE: ./components/PleaseSignIn.js
var PleaseSignIn = __webpack_require__(22);

// CONCATENATED MODULE: ./pages/chats.js





var chats_Home = function Home(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(PleaseSignIn["a" /* default */], null, external_react_default.a.createElement(components_ChatList, null)));
};

/* harmony default export */ var pages_chats = __webpack_exports__["default"] = (chats_Home);
