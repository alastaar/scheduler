...
// CONCATENATED MODULE: ./components/ChatMessages.js
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Component) {
  ...
  _createClass(ChatMessages, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(User["b" /* default */], null, function (_ref) {
        var me = _ref.data.me;
        return external_react_default.a.createElement(external_react_default.a.Fragment, null, me && external_react_default.a.createElement(RequestStyles["a" /* default */], {
          style: ({
            background: _this.props.yes === "no" ? "#bad4ff" : "white"
          }, {
            textAlign: _this.props.yes === "no" ? "right" : "left"
          })
        }, external_react_default.a.createElement("p", null, message)));
      });
    }
  }]);
...
/* harmony default export */ var components_ChatMessages = (ChatMessages_ChatMessages);
// CONCATENATED MODULE: ./components/ChatSingle.js


function ChatSingle_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { ChatSingle_typeof = function _typeof(obj) { return typeof obj; }; } else { ChatSingle_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return ChatSingle_typeof(obj); }
...
function ChatSingle_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ChatSingle_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ChatSingle_createClass(Constructor, protoProps, staticProps) { if (protoProps) ChatSingle_defineProperties(Constructor.prototype, protoProps); if (staticProps) ChatSingle_defineProperties(Constructor, staticProps); return Constructor; }

function ChatSingle_possibleConstructorReturn(self, call) { if (call && (ChatSingle_typeof(call) === "object" || typeof call === "function")) { return call; } return ChatSingle_assertThisInitialized(self); }

function ChatSingle_getPrototypeOf(o) { ChatSingle_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return ChatSingle_getPrototypeOf(o); }

function ChatSingle_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) ChatSingle_setPrototypeOf(subClass, superClass); }

function ChatSingle_setPrototypeOf(o, p) { ChatSingle_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return ChatSingle_setPrototypeOf(o, p); }

function ChatSingle_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var SingleItemStyles = external_styled_components_default.a.div.withConfig({
  displayName: "ChatSingle__SingleItemStyles",
  componentId: "kufd6e-0"
...
var SINGLE_CHAT_QUERY = external_graphql_tag_default()(_templateObject());
var CREATE_CHAT_MESSAGE_MUTATION = external_graphql_tag_default()(_templateObject2());

var ChatSingle_ChatSingle =
/*#__PURE__*/
function (_Component) {
  ChatSingle_inherits(ChatSingle, _Component);
  ...
  function ChatSingle() {
    ...
    ChatSingle_classCallCheck(this, ChatSingle);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = ChatSingle_possibleConstructorReturn(this, (_getPrototypeOf2 = ChatSingle_getPrototypeOf(ChatSingle)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(ChatSingle_assertThisInitialized(ChatSingle_assertThisInitialized(_this)), "state", {
      message: '',
      chatId: _this.props.id
    });

    _defineProperty(ChatSingle_assertThisInitialized(ChatSingle_assertThisInitialized(_this)), "handleMessageChange", function (e) {
      var _e$target = e.target,
          name = _e$target.name,
          type = _e$target.type,
          value = _e$target.value;
    ...
    _defineProperty(ChatSingle_assertThisInitialized(ChatSingle_assertThisInitialized(_this)), "createChatMessage",
    /*#__PURE__*/
    function () {
      var _ref = _asyncToGenerator(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(e, createChatMessageMutation) {
        var res;
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
  ...
  ChatSingle_createClass(ChatSingle, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      return external_react_default.a.createElement(User["b" /* default */], null, function (_ref2) {
        var me = _ref2.data.me;
        return external_react_default.a.createElement(external_react_default.a.Fragment, null, me && external_react_default.a.createElement(external_react_apollo_["Query"], {
          ...
          if (loading) return external_react_default.a.createElement("p", null, "loading..");
          if (!data.chat) return external_react_default.a.createElement("p", null, "No request found ");
          var chat = data.chat;
          var messages = chat.clientMessages;
          return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("div", null, messages.map(function (message, index) {
            return external_react_default.a.createElement(external_react_default.a.Fragment, null, me.id === message.user.id && external_react_default.a.createElement(components_ChatMessages, {
              key: index,
              message: message,
              yes: "yes"
            }), me.id !== message.user.id && external_react_default.a.createElement(components_ChatMessages, {
              key: index,
              message: message,
              yes: "no"
            }));
          ...
          }, function (createChatMessage, _ref4) {
            ...
            return external_react_default.a.createElement(Form["a" /* default */], {
                  ...
                  return regenerator_default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          _context2.next = 2;
                          return _this2.createChatMessage(e, createChatMessage);
              ...
              htmlFor: "message"
            }, "Send Message", external_react_default.a.createElement("input", {
              type: "text",
              id: "message",
              name: "message",
              placeholder: " ",
              required: true,
              defaultValue: "",
              onChange: _this2.handleMessageChange
...
/* harmony default export */ var components_ChatSingle = (ChatSingle_ChatSingle);
...
var chat_Home = function Home(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(PleaseSignIn["a" /* default */], null, external_react_default.a.createElement(components_ChatSingle, {
    id: props.query.id
  })));
};

/* harmony default export */ var pages_chat = __webpack_exports__["default"] = (chat_Home);
