...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n\t@font-face {\n\t\tfont-family: font-family: 'radnika_next';;\n\t\tsrc: url('/static/TitilliumWeb-Regular.ttf') format ('woff2');\n\t\tfont-weight: normal;\n\t\tfont-style: normal;\n\t}\n\thtml {\n\t\tbox-sizing: border-box;\n\t\tfont-size: 10px;\n\t}\n\t*, *:before, *:after {\n\t\tbox-sizing: inherit;\n\t}\n\tbody {\n\t\tpadding: 0;\n\t\tmargin: 0;\n\t\tfont-size: 1.5rem;\n\t\tline-height: 2;\n\t\tfont-family: 'radnika_next';\n\t}\n\ta {\n\t\ttext-decoration: none;\n\t\tcolor: ", ";\n\t}\n"]);
...
//# sourceMappingURL=_app.js.5bab9e63d749b81b8bd6.hot-update.js.map