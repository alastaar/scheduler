...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  mutation SIGNUP_MUTATION($email: String!, $name: String!, $lastName: String!, $password: String!, $artist: String, $emailPreference: [EmailPreference], $permission: [Permission]) {\n    signup(email: $email, name: $name, lastName: $lastName, password: $password, artist: $artist, emailPreference: $emailPreference, permission: $permission) {\n      id\n      email\n      name\n      lastName\n      artist\n      emailPreference\n    }\n  }\n"]);
...
//# sourceMappingURL=signup.js.ab62d6dd9f4f84bfa9c9.hot-update.js.map