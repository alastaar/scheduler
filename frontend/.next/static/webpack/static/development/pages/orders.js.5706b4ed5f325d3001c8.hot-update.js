...
function (_Component) {
  ...
  function ApproveRequest() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      data.requests = data.requests.filter(function (item) {
        return item.id !== payload.data.approveRequest.id;
...
//# sourceMappingURL=orders.js.5706b4ed5f325d3001c8.hot-update.js.map