...
})(["max-width:1200px;margin:2rem auto;display:grid;grid-auto-columns:1fr;grid-auto-flow:column;min-height:800px;img{width:300px;height:300px;background-size:cover;display:block;border-radius:150px;-webkit-border-radius:100px;-moz-border-radius:100px;}.details{margin:3rem;font-size:2rem;}a{background-color:", ";padding:10px 15px;color:white;font-size:15px;font-weight:800;}"], function (props) {
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Query"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SingleItemStyles, {
          ...
          __self: this
        }, user.price)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_6___default.a, {
          href: {
            pathname: '/request',
            query: {
              id: user.id,
...
//# sourceMappingURL=artist.js.b23ab991d68e6676926c.hot-update.js.map