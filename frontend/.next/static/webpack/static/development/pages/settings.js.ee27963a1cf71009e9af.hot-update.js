...
})(["font-size:2rem;width:200px;margin:0 auto;color:black;p{display:inline-block;}a{display:inline-block;font-size:1rem;font-weight:700;background-color:black;color:white;padding:10px 20px;margin:20px;width:200px;text-align:center;}button{display:inline-block;font-size:1rem;background-color:red;color:white;padding:10px 30px;margin:20px;width:200px;text-align:center;}h2{color:#3399ff;display:inline-block;}h3{margin-bottom:0;margin-top:0;}"]);
...
//# sourceMappingURL=settings.js.ee27963a1cf71009e9af.hot-update.js.map