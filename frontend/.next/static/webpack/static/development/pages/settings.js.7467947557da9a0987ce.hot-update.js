...
})(["font-size:2rem;color:black;p{display:inline-block;}a{display:inline-block;font-size:1rem;background-color:black;color:white;padding:10px 20px;}button{display:inline-block;font-size:1rem;background-color:black;color:white;padding:10px 20px;margin:20px;}h2{color:#3399ff;display:inline-block;}h3{margin-bottom:0;margin-top:0;}"]);
...
//# sourceMappingURL=settings.js.7467947557da9a0987ce.hot-update.js.map