...
var _this = undefined,
    _jsxFileName = "/Users/alistairmccormick/Documents/react/peve/sick-fits/frontend/components/CalendarList.js";
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_CalendarStyles__WEBPACK_IMPORTED_MODULE_7__["default"], {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        events: data.requests.filter(function (request) {
          ...
          return {
            title: _this.convertTime(request.timeOne) + ' ' + request.user.name + ' ' + request.user.email,
            start: _this.convertDate(request.dateOne),
            end: request.dateOne
          };
        }),
        components: {
...
function (_React$Component) {
  ...
  function CalendarComponent() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(CalendarComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "convertDate", function (date) {
      return moment__WEBPACK_IMPORTED_MODULE_6___default.a.utc(date).toDate();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "convertTime", function (time24) {
  ...
  _createClass(CalendarComponent, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, request.email === me.email && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Link, {
        href: {
...
//# sourceMappingURL=calendar.js.cff5e12df04623bd2763.hot-update.js.map