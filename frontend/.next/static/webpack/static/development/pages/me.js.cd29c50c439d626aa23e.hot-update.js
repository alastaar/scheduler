...
})(["font-size:2rem;width:100%;color:black;width:auto;a{font-size:2.5rem;background-color:#3399ff;color:white;padding:10px 20px;margin-top:30px;text-align:center;display:inherit;}"]);
...
})(["font-size:2rem;margin-top:25px;color:black;border:2px solid green;width:50%;float:right;p{margin-left:10%;}a{text-align:center;width:70%;font-size:1.5rem;margin:0 auto;background-color:#3399ff;color:white;padding:10px 50px;}"]);
...
//# sourceMappingURL=me.js.cd29c50c439d626aa23e.hot-update.js.map