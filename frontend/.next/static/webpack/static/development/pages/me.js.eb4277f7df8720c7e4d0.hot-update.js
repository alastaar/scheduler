...
})(["font-size:2rem;width:100%;color:black;a{border-radius:25px;font-size:2.5rem;background-color:#3399ff;color:white;padding:10px 20px;margin-top:30px;text-align:center;display:inherit;}"]);
...
})(["font-size:2rem;margin-top:25px;color:black;border:2px solid #3399ff;width:50%;display:inline-grid;p{margin-left:10%;}a{border-radius:25px;text-align:center;width:70%;font-size:1.5rem;margin:0 auto;background-color:#3399ff;color:white;padding:10px 50px;margin-bottom:20px;}@media only screen and (max-width:600px){display:block;width:100%;}"]);
...
//# sourceMappingURL=me.js.eb4277f7df8720c7e4d0.hot-update.js.map