...
})(["font-size:2rem;width:100%;color:black;a{font-size:2.5rem;background-color:#3399ff;color:white;padding:10px 20px;width:100px;height:100px;margin:0 auto;text-align:center;display:inherit;}"]);
...
})(["font-size:2rem;margin-top:25px;color:black;border:2px solid green;width:50%;float:right;p{margin-left:10%;}a{text-align:center;width:100%;margin-left:25%;font-size:1.5rem;background-color:#3399ff;color:white;padding:10px 50px;}"]);
...
})(["width:50%;display:inline-block;margin-top:25px;h2{margin:0;}h2{color:#3399ff;display:inline-block;}h3{margin-bottom:0;margin-top:0;}"]);
...
//# sourceMappingURL=me.js.3f0fc50428ce1381654e.hot-update.js.map