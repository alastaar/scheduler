...
function (_Component) {
  ...
  function CalendarList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "convertDate", function (date) {
      var new_date = moment__WEBPACK_IMPORTED_MODULE_6___default()(date).add(5, 'd');
      return new_date.moment.utc(date).toDate();
      ;
    });
...
//# sourceMappingURL=calendar.js.0af6a64d09d9915af9a4.hot-update.js.map