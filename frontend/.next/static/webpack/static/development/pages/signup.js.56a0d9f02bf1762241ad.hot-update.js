...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  mutation SIGNUP_MUTATION($email: String!, $name: String!, $lastName: String!, $password: String!, $artist: String, $emailPreference: [EmailPreference]) {\n    signup(email: $email, name: $name, lastName: $lastName, password: $password, artist: $artist, emailPreference: $emailPreference) {\n      id\n      email\n      name\n      lastName\n      artist\n      emailPreference\n    }\n  }\n"]);
...
function (_Component) {
  ...
  function Signup() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      ...
      password: '',
      artist: '',
      emailPreference: ['REQUESTCREATED', 'REQUESTAPPROVED', 'REQUESTCONFIRMED', 'REQUESTREJECTED', 'REQUESTDELETED', 'APPOINTMENTTOMORROW', 'UPDATEDSTRIPEACCOUNT', 'UPDATEDCARD', 'CREATECHAT', 'NEWCHATMESSAGE']
    });
...
//# sourceMappingURL=signup.js.56a0d9f02bf1762241ad.hot-update.js.map