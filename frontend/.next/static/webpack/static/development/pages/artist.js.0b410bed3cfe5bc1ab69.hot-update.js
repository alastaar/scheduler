...
})(["max-width:1200px;margin:2rem auto;box-shadow:", ";display:grid;grid-auto-columns:1fr;grid-auto-flow:column;min-height:800px;img{width:300px;height:300px;background-size:cover;display:block;border-radius:100px;-webkit-border-radius:100px;-moz-border-radius:100px;}.details{margin:3rem;font-size:2rem;}"], function (props) {
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Query"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SingleItemStyles, {
          ...
          __self: this
        }, " Scratcher | ", user.name, " ")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
          src: user.image,
          alt: user.name,
          __source: {
            fileName: _jsxFileName,
...
//# sourceMappingURL=artist.js.0b410bed3cfe5bc1ab69.hot-update.js.map