...
})(["font-size:2rem;color:black;p{display:inline-block;}a{font-size:1rem;font-weight:700;background-color:black;color:white;padding:10px 20px;margin:20px;}button{display:inline-block;font-size:1rem;background-color:red;color:white;padding:10px 30px;}h2{color:#3399ff;display:inline-block;}h3{margin-bottom:0;margin-top:0;}"]);
...
//# sourceMappingURL=settings.js.f85e45c4b6c44f9903fd.hot-update.js.map