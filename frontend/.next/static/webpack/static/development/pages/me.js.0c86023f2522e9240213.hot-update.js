...
})(["font-size:2rem;width:100%;color:black;a{font-size:2.5rem;background-color:#3399ff;color:white;padding:10px 20px;width:100px;height:100px;margin:0 auto;text-align:center;}"]);
...
})(["font-size:2rem;margin-top:25px;color:black;border:2px solid green;width:50%;float:right;p{margin-left:10%;}a{text-align:center;display:inherit width:100%;margin-left:25%;font-size:1.5rem;background-color:#3399ff;color:white;padding:10px 50px;}"]);
...
//# sourceMappingURL=me.js.0c86023f2522e9240213.hot-update.js.map