...
})(["max-width:1200px;margin:2rem auto;display:grid;grid-auto-columns:1fr;grid-auto-flow:column;min-height:400px;img{width:300px;height:300px;background-size:cover;display:block;border-radius:150px;-webkit-border-radius:100px;-moz-border-radius:100px;}.details{font-size:2rem;}"]);
...
})(["a{background-color:", ";padding:15px 20px;color:white;font-size:25px;font-weight:800;margin-left:50%;}"], function (props) {
...
//# sourceMappingURL=artist.js.cc51083161ebaab623d5.hot-update.js.map