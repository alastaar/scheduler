...
function (_Component) {
  ...
  function CalendarList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "convertDate", function (date, time) {
      ...
      var dateParts = '2014-04-03'.split('-');
      var newDate = moment__WEBPACK_IMPORTED_MODULE_6___default()(date).add(30, 'm').toDate();
      return newDate;
    });
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            ...
            events: data.requests.filter(function (request) {
              ...
              return {
                ...
                end: _this2.convertDate(request.dateOne, request.timeOne),
...
//# sourceMappingURL=calendar.js.7710723e0564f4c43735.hot-update.js.map