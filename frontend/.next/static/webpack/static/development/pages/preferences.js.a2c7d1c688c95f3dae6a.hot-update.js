...
function (_React$Component) {
  ...
  function UserPreferences() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      preferences: _this.props.user.preferences
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePreferenceChange", function (e) {
      ...
      var updatedPreference = _toConsumableArray(_this.state.preferences); // figure out if we need to remove or add this permission


      if (checkbox.checked) {
        // add it in!
        updatedPreference.push(checkbox.value);
      } else {
        updatedPreference = updatedPreferences.filter(function (preference) {
...
_defineProperty(UserPreferences, "propTypes", {
  user: prop_types__WEBPACK_IMPORTED_MODULE_6___default.a.shape({
    ...
    preferences: prop_types__WEBPACK_IMPORTED_MODULE_6___default.a.array
  }).isRequired
});
...
//# sourceMappingURL=preferences.js.a2c7d1c688c95f3dae6a.hot-update.js.map