...
})(["display:inline-block;margin-left:auto;a,button{padding:1rem 3rem;display:flex;align-items:center;position:relative;text-transform:uppercase;font-size:15px;background:none;border:0;cursor:pointer;color:white;font-weight:800;@media (max-width:700px){font-size:10px;padding:0 10px;}&:before{content:'';width:2px;height:100%;left:0;position:absolute;transform:skew(-20deg);top:0;bottom:0;}&:after{height:2px;background:#47BEE9;content:'';width:0;position:absolute;transform:translateX(-50%);transition:width 0.4s;transition-timing-function:cubic-bezier(1,-0.65,0,2.31);left:50%;margin-top:2rem;}&:hover,&:focus{outline:none;&:after{width:calc(100% - 60px);}}}button{padding:0.5rem 1rem;font-weight:900;font-size:15px;line-height:2;border:none;background:transparent;color:white;text-transform:uppercase;text-decoration:none;margin-left:15px;margin-right:15px;&:before{content:'';width:2px;height:100%;left:0;position:absolute;transform:skew(-20deg);top:0;bottom:0;}&:after{height:2px;background:#47BEE9;content:'';width:0;position:absolute;transform:translateX(-50%);transition:width 0.4s;transition-timing-function:cubic-bezier(1,-0.65,0,2.31);margin-top:2rem;}&:hover,&:focus{outline:none;&:after{width:calc(100px - 60px);}}}"]);
...
//# sourceMappingURL=_app.js.fa8bd2fe85ba5edc6c87.hot-update.js.map