...
function (_Component) {
  ...
  function CalendarList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "convertDatePlusOne", function (date, time) {
      ...
      var dateParts = date.split('-');
      var timeParts = time.split(':');
      var mydate = new Date(dateParts[0], dateParts[1] - 1, dateParts[2], timeParts[0] + 1, timeParts[1]);
      var newDate = moment__WEBPACK_IMPORTED_MODULE_6___default.a.utc(mydate).toDate();
      console.log(mydate);
      return newDate;
    });
...
//# sourceMappingURL=calendar.js.65177587553c623195c2.hot-update.js.map