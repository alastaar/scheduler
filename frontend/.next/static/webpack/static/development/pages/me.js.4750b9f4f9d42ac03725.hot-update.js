...
})(["font-size:2rem;margin-top:25px;color:black;border:2px solid green;width:50%;display:inline-grid;p{margin-left:10%;}a{border-radius:25px;text-align:center;width:70%;font-size:1.5rem;margin:0 auto;background-color:#3399ff;color:white;padding:10px 50px;margin-bottom:20px;}@media only screen and (max-width:600px){display:block;width:100%;}"]);
...
//# sourceMappingURL=me.js.4750b9f4f9d42ac03725.hot-update.js.map