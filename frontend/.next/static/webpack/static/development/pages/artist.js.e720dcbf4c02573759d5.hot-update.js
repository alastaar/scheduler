...
})(["max-width:1200px;margin:2rem auto;display:grid;grid-auto-columns:1fr;grid-auto-flow:column;min-height:800px;img{width:300px;height:300px;background-size:cover;display:block;border-radius:150px;-webkit-border-radius:100px;-moz-border-radius:100px;}.details{margin:3rem;font-size:2rem;}a{background-color:", ";padding:10px 15px;color:white;font-size:15px;}"], function (props) {
...
//# sourceMappingURL=artist.js.e720dcbf4c02573759d5.hot-update.js.map