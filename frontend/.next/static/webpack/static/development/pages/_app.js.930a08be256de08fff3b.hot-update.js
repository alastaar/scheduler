...
})(["display:inline-block;font-size:15px;margin-left:15px;margin-right:15px;position:relative;z-index:2;margin-top:0;margin-bottom:0;font-weight:900;text-transform:uppercase;text-decoration:none;"]);
var Logo = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].h1.withConfig({
  displayName: "Header__Logo",
  componentId: "sc-2cpreo-1"
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;display:inline-flex;a{padding:0.5rem 1rem;background:", ";color:white;text-transform:uppercase;text-decoration:none;}@media ( max-width:2500px){margin:0;}"], function (props) {
...
})(["display:inline-block;margin-left:auto;a{font-size:15px;padding:1rem 1rem;margin-left:15px;margin-right:15px;background:transparent;color:black;font-weight:900;}button{padding:0.5rem 1rem;font-weight:900;font-size:15px;line-height:2;border:none;background:transparent;color:black;text-transform:uppercase;text-decoration:none;margin-left:15px;margin-right:15px;}button:hover{text-decoration:underline;text-decoration-color:", ";}"], function (props) {
...
var Header = function Header() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_User__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledHeader, {
      ...
      __self: this
    }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Person, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 110
      },
      __self: this
    }, " Hello, "), me && me.artist == 'yes' && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
      href: "/me",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 113
...
//# sourceMappingURL=_app.js.930a08be256de08fff3b.hot-update.js.map